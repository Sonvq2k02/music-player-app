...
import 'package:demo_1/ui/home/viewmodel.dart';
import 'package:demo_1/ui/search/search.dart';
import 'package:demo_1/ui/setting/setting.dart';
...
import 'song_items.dart';

class MusicAppDemo extends StatelessWidget {
  const MusicAppDemo({super.key});
      ...
      child: CupertinoTabScaffold(
        tabBar: CupertinoTabBar(
          items: const [
            ...
            BottomNavigationBarItem(icon: Icon(Icons.playlist_add), label: 'Play List'),
